...
int disassemble8080(unsigned char * code_buffer, int pc)
{
	...
	switch(*code)
	{
		...
		case 0xDA: fprintf(output, "JC $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		case 0xDB: fprintf(output, "IN $%02x", code[1]); num_bytes = 2; break;
		case 0xDC: fprintf(output, "CC $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		...
		case 0xE2: fprintf(output, "JPO $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		case 0xE3: fprintf(output, "XTHL"); break;
		case 0xE4: fprintf(output, "CPO $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		...
		case 0xEA: fprintf(output, "JPE $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		case 0xEB: fprintf(output, "XCHG"); break;
		case 0xEC: fprintf(output, "CPE $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		...
		case 0xF2: fprintf(output, "JP $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		case 0xF3: fprintf(output, "DI"); break;
		case 0xF4: fprintf(output, "CP $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		...
		case 0xFA: fprintf(output, "JM $%02x%02x", code[2], code[1]); num_bytes = 3; break;
		case 0xFB: fprintf(output, "EI"); break;
		case 0xFC: fprintf(output, "CM $%02x%02x", code[2], code[1]); num_bytes = 3; break;
